...
public class RobotMap {
    ...
    // public static final int leftLiftDrive = ;
    // public static final int rightLiftDrive = ;
    ...
    //encoder positions for Climber
    public static final double lifted = 0;
    public static final double notLifted = 0;
    ...
    public static final double wristGrabPanel = -1081;

    public static final double wristCargoLow = -160;//same as panel low
    public static final double wristCargoHigh = -3920;
    
    public static final double wristBottom = -3050;
    public static final double wristMiddle = -4100;
    public static final double wristHigh = -3472;
    
    public static final double wristPanelMiddle = -1290;
    public static final double wristPanelHigh = -2250;
    ...
    public static final double desiredYValue = -20.33;
}